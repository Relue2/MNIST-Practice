...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_activation = rectified_linear_unit(hidden_layer_weighted_input) #(3 by 1 matrix)
        ...
        hidden_layer_error = np.multiply((np.transpose(self.hidden_to_output_weights) * output_layer_error), rectified_linear_unit_derivative(hidden_layer_weighted_input)) #(3 by 1 matrix)
    ...
    def predict(self, x1, x2):
        ...
        hidden_layer_activation = rectified_linear_unit(hidden_layer_weighted_input) # 3 by 1
    ...
    # Run this to train your neural network
